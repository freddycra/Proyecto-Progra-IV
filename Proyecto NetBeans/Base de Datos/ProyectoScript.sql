...
CREATE TABLE IF NOT EXISTS `puesto` (
  ...
  `descripcion` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NOT NULL,
  `salario_ofrecido` DOUBLE NOT NULL,
...
VALUES (1, 'Casino', 'Aurora Heredia', 'casino@gmail.com', 24668872, 'Venta de Ropa y Calzado', '1234', curdate(), 2);

INSERT INTO bancoempleo.empresa (id_empresa, nombre_empresa, localizacion, correo, telefono, descripcion, clave, fecha_registro, usuario)
VALUES (4, 'PNG', 'Ulloa', 'png@gmail.com', 24668898, 'Ventas', '1234', curdate(), 2);
